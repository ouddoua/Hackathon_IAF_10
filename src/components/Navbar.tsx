      ...
      <section className="relative h-[80vh] flex items-center justify-center bg-white text-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.h1
            ...
            className="text-4xl md:text-6xl font-bold mb-6 text-[#4a4a4a]" // Changement de couleur ici
          >
          ...
          <motion.p
            ...
            className="text-xl md:text-2xl mb-8 text-[#4a4a4a]" // Changement de couleur ici aussi
          >
